#Answer taken from here: https://github.com/Bruception/advent-of-code-2021/blob/main/day23/part2.py
#This one I reallly couldn't figure out...
#I did not think about A*, Dynamic programming and recursions don't make it fast enough...

import sys
import math
from functools import cache

burrow = [line for line in open("input_day_23", 'r').read().split('\n')]
